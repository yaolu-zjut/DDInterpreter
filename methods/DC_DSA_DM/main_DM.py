...
def main():
    ...
    parser.add_argument('--method', type=str, default='DM', help='DC/DSA')
    ...
    parser.add_argument('--CLoM_distance', type=str, default='ce', choices=['ce', 'cos'], help='Which distance to used for CLoM')
    ...
    parser.add_argument('--CLoM_batch_size', type=int, default=None, help='batch size of CLoM')
    ...
    if args.CLoM:
        args.save_path = os.path.join(args.save_path, 'CLoM',f'{args.CLoM_distance}_distance',
                                      f'{args.source_dataset}->{args.dataset}',
    ...
    if args.CLoM:
        ...
        our_loss = CLoM(args, args.ipc, args.CLoM_batch_size, args.CLoM_distance,
    ...
    for exp in range(args.num_exp):
        ...
        if args.CLoM_distance == 'cos':
            print("CLoM set real data")
        ...
        for it in range(args.Iteration+1):
            ...
            if args.CLoM:
                ''' calculate CLoM'''
                loss += our_loss.calculating_CLoM(image_syn, label_syn)
