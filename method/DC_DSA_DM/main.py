    ...
    for exp in range(args.num_exp):
        ...
        for it in range(args.Iteration+1):
            ...
            for ol in range(args.outer_loop):
                ...
                loss_DC_DSA = loss.item()
                print("it:", it, "ol: ", ol,  "Loss of", args.method, ":", loss_DC_DSA)

                ''' calculate CLOM'''
                loss += clom.calculate_loss(image_syn, label_syn)
                print("it:", it, "ol: ", ol, "Loss of CLOM:", loss.item() - loss_DC_DSA)
                print("it:", it, "ol: ", ol, "Whole Loss:", loss.item())
